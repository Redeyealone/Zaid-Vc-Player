...
API_ID = int(getenv("API_ID", "26403759"))
API_HASH = getenv("API_HASH", "fb48e39c2842ad640d5d1304ff5b6c83)
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://Cloner:Cloner@cluster0.cgc6t.mongodb.net/?retryWrites=true&w=majority")
OWNER_NAME = getenv("OWNER_NAME", "Redeye")
OWNER_USERNAME = getenv("OWNER_USERNAME", "redeye_alone")
ALIVE_NAME = getenv("ALIVE_NAME", "Redeye")
BOT_USERNAME = getenv("BOT_USERNAME", "Darkbutterfly")
OWNER_ID = getenv("OWNER_ID", "5483829443)
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Darkbutterfly")
...
ALIVE_IMG = getenv("ALIVE_IMG", "https://telegra.ph/file/f35cc1a711716ac6c0ad7.jpg")
START_PIC = getenv("START_PIC", "https://telegra.ph/file/e8c2feeffa2de49da63f5.jpg")
